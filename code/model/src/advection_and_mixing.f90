...
REAL(kind=rc_kind), dimension(    1:NI  ,1:NJ  , 1:NK  ) :: T_h,S_h,u_w, v_w       
...
#ifdef implicit
      mat_D(1:NI,1:NJ,1:NK,selvar)=S_h(1:NI,1:NJ,1:NK)
#else
      uvarx(1:NI,1:NJ,1:NK)=uvarx(1:NI,1:NJ,1:NK)-S_h(1:NI,1:NJ,1:NK)
#endif
